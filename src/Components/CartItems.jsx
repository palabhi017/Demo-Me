    ...
    return (
      ...
      <CardBody  h="85%">
        ...
        <Stack mt='2' spacing='1'>
          <Heading textAlign={"left"} color="#999" noOfLines={2} size='md'>{title}</Heading>
      ...
      <CardFooter>
        ...
        <Button onClick={()=>funcProp(orderId)} variant='solid' colorScheme='blue'>
          ...
          <Box>{quantity}</Box>
          <Button isDisabled={quantity===3} bgColor='#3182ce' w="10px" color="white" onClick={()=> funcquant(orderId,1)} variant='ghost' colorScheme='blue'>+</Button>
          </HStack>
        </HStack>
